...
| --- | --- | --- |
| **Provide verification criteria** | *”implement a function that validates email addresses"* | *"write a validateEmail function. example test cases: [[email protected]](/cdn-cgi/l/email-protection#97e2e4f2e5d7f2eff6fae7fbf2b9f4f8fa) is true, invalid is false, [[email protected]](/cdn-cgi/l/email-protection#c3b6b0a6b183eda0acae) is false. run the tests after implementing”* |
